    ...
    <>
      ...
      <motion.header
        ...
        className={cn(
          ...
          scrolled && "shadow-2xl shadow-black/20 border-b border-white/[0.06]"
        )}
      >
          ...
          <nav className="hidden lg:flex items-center gap-0.5">
            {NAV_LINKS.map((link) => (
              <Link
                key={link.href}
                href={link.href}
                className="relative px-4 py-2 text-[13px] font-medium tracking-wide uppercase group"
              >
                <span className={cn(
          ...
          <div className="flex items-center gap-2">
            <Link href="/dashboard" className="hidden md:inline-flex">
              <Button
                variant="ghost"
                size="sm"
                className="text-stone-400 hover:text-white hover:bg-white/5 gap-1.5 text-xs font-medium transition-all duration-300"
              >
              ...
              <nav className="flex flex-col items-center gap-2 w-full max-w-sm">
                ...
                >
                  ...
                  <Link href="/dashboard" onClick={() => setMobileOpen(false)}>
                    <Button variant="outline" className="w-full border-white/10 text-stone-300 hover:text-white hover:bg-white/5 gap-2 h-12">
