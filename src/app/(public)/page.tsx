...
function SectionHeading({ eyebrow, title, description, light = false }: {
  ...
  return (
    <FadeIn className="text-center mb-16">
      <span className={`inline-flex items-center gap-2 text-xs font-semibold tracking-[0.25em] uppercase mb-4 ${light ? "text-amber-500" : "text-green-700"}`}>
  ...
  return (
    <>
      ...
      <section ref={heroRef} className="relative overflow-hidden min-h-[100vh] flex items-center text-white">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-green-950/80 via-green-950/50 to-green-950/90" />
        ...
        <motion.div className="relative container mx-auto px-6 py-24 md:py-32 lg:py-40" style={{ y: heroContentY, opacity: heroOpacity }}>
          <div className="max-w-4xl">
            ...
            <motion.div
              ...
              className="h-[2px] bg-gradient-to-r from-green-500 to-amber-600 mb-8"
            />
            ...
            <motion.p
              ...
              className="text-xs font-semibold tracking-[0.3em] uppercase text-amber-500 mb-6"
            >
            ...
            >
              ...
              <motion.span
                ...
                className="inline-block bg-gradient-to-r from-amber-600 via-amber-400 to-amber-600 bg-clip-text text-transparent"
              >
                Retreat
              </motion.span>
              <br />
            ...
            >
              <Link href="/booking">
                <motion.div whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.97 }} transition={SPRING_SNAPPY}>
                  <Button size="lg" className="gap-2 min-w-[200px] bg-gradient-to-r from-amber-600 to-amber-600 hover:from-green-500 hover:to-amber-600 text-green-950 font-semibold shadow-2xl shadow-amber-600/20 text-sm h-13 tracking-wide uppercase">
                    Reserve Your Stay
      ...
      <section className="relative z-10 -mt-20 pb-16">
        <div className="container mx-auto px-6">
          <FadeIn y={20}>
            <div className="bg-white rounded-2xl shadow-2xl shadow-green-900/10 border border-stone-100 p-6 md:p-8">
              <div className="flex flex-col md:flex-row items-end gap-4">
                <div className="flex-1 w-full grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div>
                    ...
                    <div className="flex items-center gap-2 border border-stone-200 rounded-xl px-4 h-12 text-sm text-stone-600 bg-[#faf8f5]/50">
                ...
                <Link href="/booking" className="w-full md:w-auto">
                  <Button className="w-full md:w-auto bg-gradient-to-r from-amber-600 to-amber-600 hover:from-green-500 hover:to-amber-600 text-green-950 font-semibold shadow-lg shadow-amber-600/15 h-12 px-8 text-sm tracking-wide uppercase">
                    Check Availability
                  </Button>
                </Link>
              </div>
              ...
              return (
                <StaggerItem key={service.title}>
                  <motion.div
                    ...
                    className="group relative p-7 rounded-2xl border border-stone-100 hover:border-green-200/60 bg-white hover:bg-gradient-to-b hover:from-green-50/40 hover:to-white transition-colors duration-500 hover:shadow-xl hover:shadow-green-900/5"
                  >
                    {/* Gold corner accent */}
                    <div className="absolute top-0 left-0 w-8 h-8 border-t-2 border-l-2 border-green-600/0 group-hover:border-green-600/40 rounded-tl-2xl transition-all duration-500" />

                    <div className="inline-flex items-center justify-center w-14 h-14 rounded-xl bg-[#faf8f5] group-hover:bg-green-50 text-stone-600 group-hover:text-green-700 mb-5 transition-all duration-300">
            ...
            {ROOMS.map((room) => (
              <StaggerItem key={room.slug}>
                <motion.div
                  ...
                  transition={SPRING_SNAPPY}
                  className={`group relative bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-2xl hover:shadow-green-900/10 transition-shadow duration-500 ${room.featured ? "ring-1 ring-amber-600/50" : ""}`}
                >
                  {/* Image */}
                  <div className="relative h-56 overflow-hidden">
                    ...
                    {room.featured && (
                      <div className="absolute top-4 left-4">
                        <span className="inline-flex items-center gap-1 bg-green-500 text-green-950 text-[10px] font-bold tracking-wider uppercase px-3 py-1.5 rounded-full shadow-lg">
                  ...
                  {/* Content */}
                  <div className="p-6">
                    <h3 className="font-[family-name:var(--font-playfair)] text-xl font-bold text-stone-900 mb-2 group-hover:text-green-700 transition-colors">
                      {room.name}
                    </h3>
                    ...
                    <div className="flex flex-wrap gap-1.5 mb-5">
                      {room.amenities.slice(0, 3).map((a) => (
                        <span key={a} className="text-[10px] px-2.5 py-1 rounded-full bg-[#faf8f5] text-stone-500 border border-stone-100 font-medium">
                          {a}
                        </span>
                      ))}
                    ...
                    <Link href="/booking">
                      <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} transition={SPRING_SNAPPY}>
                        <Button className="w-full bg-green-900 hover:bg-green-800 text-white font-medium gap-2 h-11 text-sm tracking-wide group/btn">
                          Book This Room
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <SlideIn direction="left" className="order-2 lg:order-1">
              ...
              <h2 className="font-[family-name:var(--font-playfair)] text-3xl md:text-4xl lg:text-5xl font-bold text-stone-900 mb-6 leading-tight">
                ...
                <br />
                <span className="text-green-700">in Nature</span>
              </h2>
            ...
            <SlideIn direction="right" className="order-1 lg:order-2" delay={0.2}>
              <div className="relative">
                ...
                <div className="absolute -bottom-8 -left-4 md:-left-8 w-48 md:w-64 rounded-2xl overflow-hidden shadow-2xl shadow-green-900/15 border-4 border-white">
                  <Image
                ...
                <div className="absolute -bottom-11 right-8 bg-gradient-to-r from-amber-600 to-amber-600 text-green-950 px-5 py-2.5 rounded-xl shadow-lg">
      ...
      {/* ═══════════════════ STATS (dark section) ═══════════════════ */}
      <section className="relative py-20 md:py-28 text-white overflow-hidden bg-green-950">
            ...
            {[
              ...
              <StaggerItem key={stat.label}>
                <div className="text-center p-6 rounded-2xl border border-white/[0.06] bg-white/[0.02]">
                  <div className="font-[family-name:var(--font-playfair)] text-4xl md:text-5xl font-bold mb-3 bg-gradient-to-b from-amber-600 to-amber-600 bg-clip-text text-transparent">
            ...
            {AMENITIES.map((amenity) => {
              ...
              return (
                <StaggerItem key={amenity.title}>
                  <div className="group flex items-start gap-4 p-5 rounded-2xl border border-transparent hover:border-stone-100 hover:bg-[#faf8f5]/50 transition-all duration-300">
                    <div className="shrink-0 w-12 h-12 rounded-xl bg-gradient-to-br from-green-50 to-green-100/50 flex items-center justify-center text-green-700 group-hover:scale-105 transition-transform">
            ...
            {HALLS.map((hall, i) => {
              ...
              return (
                <StaggerItem key={hall.name}>
                  <motion.div whileHover={{ y: -6, scale: 1.01 }} transition={SPRING_SNAPPY} className="group relative bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-2xl hover:shadow-green-900/10 transition-shadow duration-500">
      ...
      {/* ═══════════════════ TESTIMONIAL / TAGLINE ═══════════════════ */}
      <section className="relative py-24 md:py-32 text-white overflow-hidden bg-green-950">
        <Image src={IMAGES.lifestyle.fellowship} alt="Fellowship at WPTC" fill className="object-cover opacity-15" sizes="100vw" />
        <div className="absolute inset-0 bg-gradient-to-b from-green-950/50 via-transparent to-green-950/50" />
      ...
      <section className="relative py-24 md:py-32 text-white overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-green-950/90 via-green-900/80 to-green-950/90" />

        <div className="relative container mx-auto px-6 text-center">
          <FadeIn>
            <span className="inline-flex items-center gap-2 text-xs font-semibold tracking-[0.25em] uppercase mb-6 text-amber-500">
              <span className="w-8 h-px bg-current" />
              Begin Your Journey
              <span className="w-8 h-px bg-current" />
            </span>
          ...
          <FadeIn delay={0.5} className="flex flex-wrap items-center justify-center gap-8 text-xs text-stone-400 tracking-wide">
            ...
            <a href="https://maps.google.com" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-amber-500 transition-colors">
